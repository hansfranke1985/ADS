...
\hypersetup{
  pdftitle={Exercises\_1\_script.R},
  pdfauthor={hansf},
  hidelinks,
...
\NormalTok{Hitters =}\StringTok{ }\NormalTok{Hitters}

\CommentTok{\# General Graph Grammar}
...
\CommentTok{\# histogram of the distribution of salary}
\KeywordTok{hist}\NormalTok{(Hitters}\OperatorTok{$}\NormalTok{Salary, }\DataTypeTok{xlab =} \StringTok{"Salary in thousands of dollars"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\includegraphics{Exercises_1_script_files/figure-latex/unnamed-chunk-1-1.pdf}
...
\KeywordTok{barplot}\NormalTok{(}\KeywordTok{table}\NormalTok{(Hitters}\OperatorTok{$}\NormalTok{League))}
\end{Highlighting}
\end{Shaded}

\includegraphics{Exercises_1_script_files/figure-latex/unnamed-chunk-1-2.pdf}
...
\includegraphics{Exercises_1_script_files/figure-latex/unnamed-chunk-1-3.pdf}
...
\includegraphics{Exercises_1_script_files/figure-latex/unnamed-chunk-1-4.pdf}
