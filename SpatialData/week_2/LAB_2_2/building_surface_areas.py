...
#You can then iterate over each feature in a layer using a for loop. 
num_features = layer_original.GetFeatureCount() #define the superior limit
print(num_features)

for i in range(1,num_features+1):
    
    #load geometry from the original layer
    feature = layer_original.GetFeature(i) #each feature is a row in the table
    ...
    centroid_layer.CreateFeature(point_feature) #add to the layer
